...
namespace Autopecas
{
    public partial class Compras : Form
    {
        ...
        private void btn_finalizaCompra_Click(object sender, EventArgs e)
        {
        ...
        private void dataGridView_Carrinho_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void label_CodigoProduto_Click(object sender, EventArgs e)
        {
        ...
        private void label_subtotal_Click(object sender, EventArgs e)
        {

        }

        private void label_Quantidade_Click(object sender, EventArgs e)
        {

        }

        private void label_NomeProduto_Click(object sender, EventArgs e)
        {
        ...
        private void textBox_CodigoProduto_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void label_Carrinho_Click(object sender, EventArgs e)
        {

        }

        private void txt_NovaCompra_Click(object sender, EventArgs e)
        {
